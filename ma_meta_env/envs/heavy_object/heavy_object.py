...
class HeavyObjectEnv(gym.Env):
    ...
    def __init__(
        ...
        self.stick_length =1.0 *num_agents
    ...
    def get_angle_offsets(self):
        ...
        if self.num_agents == 1:
            ...
            return np.array([0, np.pi / 2, np.pi])
    ...
    def get_pos_gpos(self, state=None):
        ...
        angles = self.regulate_radians(angle + self.angle_offsets)
        goal_angles = self.regulate_radians(goal_angle + self.angle_offsets)
